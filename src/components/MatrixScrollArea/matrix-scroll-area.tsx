...
export const MatrixScrollArea = ({
  ...
  onScrollEnd,
  onScrollTop,
  virtualizeThreshold, // eslint-disable-line @typescript-eslint/no-unused-vars
  className = '',
  style,
  ref,
  ...props
}: MatrixScrollAreaProps & { ref?: React.Ref<MatrixScrollAreaRef> }) => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div ref={scrollRef} className={containerClasses} style={containerStyle} {...props}>
        {children}
      </div>
